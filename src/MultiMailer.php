...
namespace IdeaCatLab\LaravelMultiMail;
...
class MultiMailer
{
    ...
    public function getMailer($key, $timeout = null, $frequency = null, $fromName = null)
    {
        ...
        if (isset($this->mailers[$config->getEmail()])) {
            $this->mailers[$config->getEmail()]->alwaysFrom($config->getFromEmail(), $fromName ?? $config->getFromName());
     ...
     *
     * @param  mixed  $users
     * @return \IdeaCatLab\MultiMail\PendingMail
     */
     ...
     *
     * @param  Mailable
     * @return \IdeaCatLab\MultiMail\MultiMailer
     */
